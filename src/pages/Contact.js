...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.send('service_fsfwkwi', 'template_u62f8th', values, 'oLBLx926DIh1RhrZH')
    .then(response => {
    ...
    <div style={{overflowX:"hidden"}}>
      ...
      <header className="pb-4 mb-4">
        <div className="row pb-4 contact_img mb-3">
            <div className="container overlay_img img-fluid"><br /> <br />
                <h1 className="mx-4 float-left my-5 py-4 text-white">Contact Us</h1>
            </div>
        </div>
      </header>
      ...
      <div className='container'>
        ...
        <div className="col-md-6">
          ...
          <span>
              ...
              <a href="mailto:info@bookshop.com.pk" type="email" className="text-dark ms-2 text-decoration-none"> 
          ...
          <div className="col-md-6">
            <form className="text-left" method="POST" onSubmit={handleSubmit} onChange={handleChange}>
                <div className="form-group">
                  <label>Full Name <code>*</code></label>
                  <input type="text" required placeholder="Your Full Name" name='fullName' value={values.fullName} className="form-control" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <textarea className="form-control" required placeholder="Your Message here." name='message' value={values.message} rows="4"></textarea>
                </div>
                {status && renderAlert()}
                <button className="btn btn-outline-primary text-left my-2" type="submit">Send Message</button>
            </form>
          </div>
